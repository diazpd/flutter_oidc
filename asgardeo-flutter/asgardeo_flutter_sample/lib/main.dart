...
class _MyAppState extends State<MyApp> {
  ...
  final TextEditingController _claimsTokenTextController = TextEditingController();
  final TextEditingController _refreshTokenTextController =
  TextEditingController();
  String? _userInfo;


  final String _clientId = 'flutterClientTest';
  final String _redirectUrl = 'wso2.asgardeo.sampleflutterapp:/oauthredirect/login';
  final String _issuer = 'https://qaautenticaciondigital.and.gov.co';
  final String _discoveryUrl =
      'https://qaautenticaciondigital.and.gov.co/.well-known/openid-configuration';
  final String _postLogoutRedirectUrl = 'wso2.asgardeo.sampleflutterapp:/';
  ...
  const AuthorizationServiceConfiguration(
    authorizationEndpoint: 'https://qaautenticaciondigital.and.gov.co/connect/authorize',
    tokenEndpoint: 'https://qaautenticaciondigital.and.gov.co/connect/token',
    endSessionEndpoint: 'https://qaautenticaciondigital.and.gov.co/connect/endsession'
  );
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Flutter OIDC Example App'),
        ),
        body: SafeArea(
          child: SingleChildScrollView(
            child: Column(
              ...
              ElevatedButton(
                ...
                const Text('Claims example'),
                TextField(
                  controller: _claimsTokenTextController,
                ),
  ...
  void _clearSessionInfo() {
    setState(() {
      ...
      _claimsTokenTextController.clear();
      _refreshToken = null;
...
*/
  ...
  void _processTokenResponse(TokenResponse? response) {
    setState(() {
      ...
      _jwt = parseJwt(response.idToken.toString());
      _firstName = _jwt['PrimerNombre'].toString();
      _lastName = _jwt['PrimerApellido'].toString();
      _displayName = _jwt['name'].toString();
      _email = _jwt['email'].toString();

      _claimsTokenTextController.text=_firstName +" -- "+_lastName;
  ...
  Future<void> _testApi(TokenResponse? response) async {
    final http.Response httpResponse = await http.get(
        Uri.parse('http://10.0.2.2:8080/WeatherForecast/Get'),
